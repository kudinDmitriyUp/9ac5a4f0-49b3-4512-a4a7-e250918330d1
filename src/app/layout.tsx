...
export const metadata: Metadata = {
  title: "Premium Wine Tours & Vineyard Excursions",
  description: "Discover guided wine tours and vineyard excursions with expert sommeliers. Experience fine wine tasting, winemaking, and gourmet dining.",
  keywords: "wine tours, vineyard excursions, wine tasting, sommelier, wine experiences, wine travel",
  ...
  openGraph: {
    title: "Premium Wine Tours & Vineyard Excursions",
    description: "Discover guided wine tours and vineyard excursions with expert sommeliers. Experience fine wine tasting and winemaking.",
    type: "website",
    siteName: "Wine Tours"
  },
  twitter: {
    ...
    title: "Premium Wine Tours & Vineyard Excursions",
    description: "Discover guided wine tours with expert sommeliers"
  },
  robots: {
    index: true,
    follow: true
